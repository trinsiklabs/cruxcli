...
1. `$CRUXCLI_INSTALL_DIR` - Özel kurulum dizini
2. `$XDG_BIN_DIR` - XDG Base Directory Specification uyumlu yol
3. `$HOME/bin` - Standart kullanıcı binary dizini (varsa veya oluşturulabiliyorsa)
4. `$HOME/.cruxcli/bin` - Varsayılan yedek konum
...
CruxCLI, `Tab` tuşuyla aralarında geçiş yapabileceğiniz iki yerleşik (built-in) ajan içerir.
...
[Ajanlar](https://cruxcli.ai/docs/agents) hakkında daha fazla bilgi edinin.

### Dokümantasyon

CruxCLI'u nasıl yapılandıracağınız hakkında daha fazla bilgi için [**dokümantasyonumuza göz atın**](https://cruxcli.ai/docs).

### Katkıda Bulunma

CruxCLI'a katkıda bulunmak istiyorsanız, lütfen bir pull request göndermeden önce [katkıda bulunma dokümanlarımızı](./CONTRIBUTING.md) okuyun.

### CruxCLI Üzerine Geliştirme

CruxCLI ile ilgili bir proje üzerinde çalışıyorsanız ve projenizin adının bir parçası olarak "cruxcli" kullanıyorsanız (örneğin, "cruxcli-dashboard" veya "cruxcli-mobile"), lütfen README dosyanıza projenin CruxCLI ekibi tarafından geliştirilmediğini ve bizimle hiçbir şekilde bağlantılı olmadığını belirten bir not ekleyin.
...
- %100 açık kaynak
- Herhangi bir sağlayıcıya bağlı değil. [CruxCLI Zen](https://cruxcli.ai/zen) üzerinden sunduğumuz modelleri önermekle birlikte; CruxCLI, Claude, OpenAI, Google veya hatta yerel modellerle kullanılabilir. Modeller geliştikçe aralarındaki farklar kapanacak ve fiyatlar düşecek, bu nedenle sağlayıcıdan bağımsız olmak önemlidir.
- Kurulum gerektirmeyen hazır LSP desteği
- TUI odaklı yaklaşım. CruxCLI, neovim kullanıcıları ve [terminal.shop](https://terminal.shop)'un geliştiricileri tarafından geliştirilmektedir; terminalde olabileceklerin sınırlarını zorlayacağız.
- İstemci/sunucu (client/server) mimarisi. Bu, örneğin CruxCLI'un bilgisayarınızda çalışması ve siz onu bir mobil uygulamadan uzaktan yönetmenizi sağlar. TUI arayüzü olası istemcilerden sadece biridir.

---

**Topluluğumuza katılın** [Discord](https://discord.gg/cruxcli) | [X.com](https://x.com/cruxcli)
