...
import { IconCruxcli } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "cruxcli/session/message-v2"
import type { Message } from "cruxcli/session/message"
import type { Session } from "cruxcli/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.cruxcli_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.cruxcli_name}>
                    <IconCruxcli width={16} height={16} />
                  </div>
