export const dict = {
  ...
  "desktop.menu.help.documentation": "CruxCLI Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "CruxCLI CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
