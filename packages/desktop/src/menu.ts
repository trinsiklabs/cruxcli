    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://cruxcli.dev/docs"),
            text: t("desktop.menu.help.documentation"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://discord.com/invite/cruxcli"),
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/trinsiklabs/cruxcli/issues/new?template=feature_request.yml"),
            text: t("desktop.menu.help.shareFeedback"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/trinsiklabs/cruxcli/issues/new?template=bug_report.yml"),
