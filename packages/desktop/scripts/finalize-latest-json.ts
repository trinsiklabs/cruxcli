...
const releaseId = process.env.CRUXCLI_RELEASE
if (!releaseId) throw new Error("CRUXCLI_RELEASE is required")

const version = process.env.CRUXCLI_VERSION
if (!releaseId) throw new Error("CRUXCLI_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "cruxcli-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "cruxcli-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "cruxcli-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "cruxcli-desktop-linux-aarch64.rpm" },
  { key: "windows-x86_64-nsis", asset: "cruxcli-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "cruxcli-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "cruxcli-desktop-darwin-aarch64.app.tar.gz",
  },
]
