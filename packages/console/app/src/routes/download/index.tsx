...
import desktopAppIcon from "../../asset/lander/cruxcli-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://cruxcli.dev/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>cruxcli.dev/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g cruxcli")}>
                <code>
                  npm i -g <strong>cruxcli</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g cruxcli")}>
                <code>
                  bun add -g <strong>cruxcli</strong>
                </code>
                <CopyStatus />
              </button>
              ...
              <button data-component="cli-row" onClick={handleCopyClick("paru -S cruxcli")}>
                <code>
                  paru -S <strong>cruxcli</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask cruxcli-desktop")}>
                <code>
                  brew install --cask <strong>cruxcli-desktop</strong>
                </code>
                <CopyStatus />
              </button>
