...
import { and, Database, eq, isNull, lt, or, sql } from "@cruxcli/console-core/drizzle/index.js"
import { KeyTable } from "@cruxcli/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@cruxcli/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@cruxcli/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@cruxcli/console-core/util/date.js"
import { Identifier } from "@cruxcli/console-core/identifier.js"
import { Billing } from "@cruxcli/console-core/billing.js"
import { Actor } from "@cruxcli/console-core/actor.js"
import { WorkspaceTable } from "@cruxcli/console-core/schema/workspace.sql.js"
import { ZenData } from "@cruxcli/console-core/model.js"
import { Subscription } from "@cruxcli/console-core/subscription.js"
import { BlackData } from "@cruxcli/console-core/black.js"
import { UserTable } from "@cruxcli/console-core/schema/user.sql.js"
import { ModelTable } from "@cruxcli/console-core/schema/model.sql.js"
import { ProviderTable } from "@cruxcli/console-core/schema/provider.sql.js"
...
import { LiteData } from "@cruxcli/console-core/lite.js"
import { Resource } from "@cruxcli/console-resource"
...
export async function handler(
  ...
  const ADMIN_WORKSPACES = [
    ...
    "wrk_01K6W1A3VE0KMNVSCQT43BG2SX", // cruxcli bench
  ]
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-cruxcli-session") ?? ""
    const requestId = input.request.headers.get("x-cruxcli-request") ?? ""
    const projectId = input.request.headers.get("x-cruxcli-project") ?? ""
    const ocClient = input.request.headers.get("x-cruxcli-client") ?? ""
    logger.metric({
      is_tream: isStream,
      session: sessionId,
      request: requestId,
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-cruxcli-request")
          headers.delete("x-cruxcli-session")
          headers.delete("x-cruxcli-project")
          headers.delete("x-cruxcli-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    const billingUrl = `https://cruxcli.dev/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://cruxcli.dev/workspace/${authInfo.workspaceID}/members`
