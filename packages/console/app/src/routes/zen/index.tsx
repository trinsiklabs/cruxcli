...
import compareVideo from "../../asset/lander/cruxcli-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/cruxcli-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="cruxcli:auth" content={loggedin() ? "true" : "false"} />
