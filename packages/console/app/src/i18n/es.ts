...
export const dict = {
  ...
  "notFound.title": "No encontrado | cruxcli",
  "notFound.heading": "404 - Página no encontrada",
  "notFound.home": "Inicio",
  "notFound.docs": "Documentación",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "cruxcli logo claro",
  "notFound.logoDarkAlt": "cruxcli logo oscuro",
  ...
  "app.meta.description": "CruxCLI - El agente de codificación de código abierto.",

  "home.title": "CruxCLI | El agente de codificación IA de código abierto",

  "temp.title": "cruxcli | Agente de codificación IA creado para la terminal",
  ...
  "temp.feature.zen.afterLink": "proporcionada por cruxcli",
  ...
  "temp.screenshot.caption": "cruxcli TUI con el tema tokyonight",
  "temp.screenshot.alt": "cruxcli TUI con tema tokyonight",
  "temp.logoLightAlt": "logo de cruxcli claro",
  "temp.logoDarkAlt": "logo de cruxcli oscuro",
  ...
  "home.what.title": "¿Qué es CruxCLI?",
  "home.what.body":
    "CruxCLI es un agente de código abierto que te ayuda a escribir código en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con más de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y más de <strong>{{commits}}</strong> commits, CruxCLI es usado y confiado por más de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "CruxCLI no almacena tu código ni datos de contexto, para que pueda operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Más información sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "¿Qué es CruxCLI?",
  "home.faq.a1":
    "CruxCLI es un agente de código abierto que te ayuda a escribir y ejecutar código con cualquier modelo de IA. Está disponible como interfaz de terminal, aplicación de escritorio o extensión de IDE.",
  "home.faq.q2": "¿Cómo uso CruxCLI?",
  "home.faq.a2.before": "La forma más fácil de empezar es leer la",
  "home.faq.a2.link": "introducción",
  "home.faq.q3": "¿Necesito suscripciones extra de IA para usar CruxCLI?",
  "home.faq.a3.p1":
    "No necesariamente, CruxCLI viene con un conjunto de modelos gratuitos que puedes usar sin crear una cuenta.",
  ...
  "home.faq.a3.p3":
    "Aunque animamos a los usuarios a usar Zen, CruxCLI también funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "¿Puedo usar mis suscripciones de IA existentes con CruxCLI?",
  "home.faq.a4.p1":
    "Sí, CruxCLI soporta planes de suscripción de los principales proveedores. Puedes usar tus suscripciones de Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "¿Solo puedo usar CruxCLI en la terminal?",
  "home.faq.a5.beforeDesktop": "¡Ya no! CruxCLI ahora está disponible como una aplicación para tu",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "¿Cuánto cuesta CruxCLI?",
  "home.faq.a6":
    "CruxCLI es 100% gratuito de usar. También viene con un conjunto de modelos gratuitos. Puede haber costos adicionales si conectas cualquier otro proveedor.",
  ...
  "home.faq.q8": "¿Es CruxCLI de código abierto?",
  "home.faq.a8.p1": "Sí, CruxCLI es totalmente de código abierto. El código fuente es público en",
  ...
  "home.zenCta.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que CruxCLI ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes entre proveedores, usa modelos validados que funcionan.",
  "home.zenCta.link": "Aprende sobre Zen",

  "zen.title":
    "CruxCLI Zen | Un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación",
  "zen.hero.title": "Modelos optimizados y confiables para agentes de codificación",
  "zen.hero.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que CruxCLI ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes, usa modelos validados que funcionan.",

  "zen.faq.q1": "¿Qué es CruxCLI Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y evaluados para agentes de codificación, creado por el equipo detrás de CruxCLI.",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen te transfiere los costos de los proveedores de modelos. Cuanto mayor sea el uso de Zen, más podrá CruxCLI negociar mejores tarifas y transferírtelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, CruxCLI añade solo una pequeña tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona genial con CruxCLI, puedes usar Zen con cualquier agente. Sigue las instrucciones de configuración en tu agente de codificación preferido.",
  ...
  "zen.problem.subtitle": "Estamos arreglando esto para todos, no solo para usuarios de CruxCLI.",
  ...
  "zen.how.body": "Aunque sugerimos usar Zen con CruxCLI, puedes usar Zen con cualquier agente.",
  ...
  "go.title": "CruxCLI Go | Modelos de programación de bajo coste para todos",
  "go.meta.description":
  ...
  "go.problem.body":
    "Estamos enfocados en llevar la experiencia de CruxCLI a tanta gente como sea posible. CruxCLI Go es una suscripción de bajo coste (10 $/mes) diseñada para llevar la programación agéntica a programadores de todo el mundo. Proporciona límites generosos y acceso fiable a los modelos de código abierto más capaces.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go es una suscripción de 10 $/mes que puedes usar con CruxCLI o cualquier agente.",
  ...
  "black.meta.title": "CruxCLI Black | Accede a los mejores modelos de codificación del mundo",
  "black.meta.description": "Obtén acceso a Claude, GPT, Gemini y más con los planes de suscripción de CruxCLI Black.",
  ...
  "black.title": "CruxCLI Black | Precios",
  ...
  "black.workspace.title": "CruxCLI Black | Seleccionar Espacio de Trabajo",
  "black.workspace.selectPlan": "Selecciona un espacio de trabajo para este plan",
  "black.workspace.name": "Espacio de trabajo {{n}}",
  "black.subscribe.title": "Suscribirse a CruxCLI Black",
  ...
  "black.subscribe.success.title": "Estás en la lista de espera de CruxCLI Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con cruxcli cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona cruxcli",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia cruxcli y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de cruxcli.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de cruxcli Gateway",
  ...
  "workspace.black.subscription.message": "Estás suscrito a CruxCLI Black por ${{plan}} al mes.",
  ...
  "workspace.black.waitlist.joined": "Estás en la lista de espera para el plan CruxCLI Black de ${{plan}} al mes.",
  "workspace.black.waitlist.ready": "Estamos listos para inscribirte en el plan CruxCLI Black de ${{plan}} al mes.",
  ...
  "workspace.lite.subscription.message": "Estás suscrito a CruxCLI Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecciona "CruxCLI Go" como proveedor en tu configuración de cruxcli para usar los modelos Go.',
  "workspace.lite.other.title": "Suscripción Go",
  "workspace.lite.other.message":
    "Otro miembro de este espacio de trabajo ya está suscrito a CruxCLI Go. Solo un miembro por espacio de trabajo puede suscribirse.",
  "workspace.lite.promo.title": "CruxCLI Go",
  "workspace.lite.promo.description":
    "CruxCLI Go es una suscripción de $10 al mes que proporciona acceso confiable a modelos de codificación abiertos populares con generosos límites de uso.",
  ...
  "download.title": "CruxCLI | Descargar",
  "download.meta.description": "Descarga CruxCLI para macOS, Windows y Linux",
  "download.hero.title": "Descargar CruxCLI",
  "download.hero.subtitle": "Disponible en Beta para macOS, Windows y Linux",
  "download.hero.button": "Descargar para {{os}}",
  "download.section.terminal": "CruxCLI Terminal",
  "download.section.desktop": "CruxCLI Desktop (Beta)",
  "download.section.extensions": "Extensiones CruxCLI",
  "download.section.integrations": "Integraciones CruxCLI",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitarás una suscripción de IA si quieres conectar CruxCLI a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", CruxCLI funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "CruxCLI es 100% gratuito de usar.",
  "download.faq.a5.p2.beforeZen":
    "Cualquier costo adicional vendrá de tu suscripción a un proveedor de modelos. Aunque CruxCLI funciona con cualquier proveedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Tus datos e información solo se almacenan cuando creas enlaces compartibles en CruxCLI.",
  "download.faq.a6.p2.beforeShare": "Más información sobre",
  "download.faq.a6.shareLink": "páginas compartidas",

  "enterprise.title": "CruxCLI | Soluciones empresariales para tu organización",
  "enterprise.meta.description": "Contacta a CruxCLI para soluciones empresariales",
  "enterprise.hero.title": "Tu código es tuyo",
  "enterprise.hero.body1":
    "CruxCLI opera de forma segura dentro de tu organización sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo, luego despliégalo en toda tu organización integrándolo con tu SSO y pasarela de IA interna.",
  ...
  "enterprise.faq.q1": "¿Qué es CruxCLI Enterprise?",
  "enterprise.faq.a1":
    "CruxCLI Enterprise es para organizaciones que quieren asegurar que su código y datos nunca salgan de su infraestructura. Puede hacer esto usando una configuración centralizada que se integra con tu SSO y pasarela de IA interna.",
  "enterprise.faq.q2": "¿Cómo empiezo con CruxCLI Enterprise?",
  "enterprise.faq.a2":
    "Simplemente empieza con una prueba interna con tu equipo. CruxCLI por defecto no almacena tu código ni datos de contexto, haciendo fácil empezar. Luego contáctanos para discutir precios y opciones de implementación.",
  ...
  "enterprise.faq.q4": "¿Están mis datos seguros con CruxCLI Enterprise?",
  "enterprise.faq.a4":
    "Sí. CruxCLI no almacena tu código ni datos de contexto. Todo el procesamiento ocurre localmente o a través de llamadas directas a la API de tu proveedor de IA. Con configuración central y integración SSO, tus datos permanecen seguros dentro de la infraestructura de tu organización.",

  "brand.title": "CruxCLI | Marca",
  "brand.meta.description": "Guías de marca de CruxCLI",
  "brand.heading": "Guías de marca",
  "brand.subtitle": "Recursos y activos para ayudarte a trabajar con la marca CruxCLI.",
  "brand.downloadAll": "Descargar todos los activos",

  "changelog.title": "CruxCLI | Registro de cambios",
  "changelog.meta.description": "Notas de versión y registro de cambios de CruxCLI",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras para CruxCLI",
