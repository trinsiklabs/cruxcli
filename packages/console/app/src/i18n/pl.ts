...
export const dict = {
  ...
  "notFound.title": "Nie znaleziono | cruxcli",
  "notFound.heading": "404 - Nie znaleziono strony",
  "notFound.home": "Strona główna",
  "notFound.docs": "Dokumentacja",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "jasne logo cruxcli",
  "notFound.logoDarkAlt": "ciemne logo cruxcli",
  ...
  "app.meta.description": "CruxCLI - Otwartoźródłowy agent programistyczny.",

  "home.title": "CruxCLI | Open source'owy agent AI do kodowania",

  "temp.title": "cruxcli | Agent AI do kodowania zbudowany dla terminala",
  "temp.hero.title": "Agent AI do kodowania zbudowany dla terminala",
  "temp.zen": "cruxcli zen",
  ...
  "temp.feature.zen.afterLink": "dostarczana przez cruxcli",
  "temp.feature.models.beforeLink": "Obsługuje 75+ dostawców LLM przez",
  "temp.feature.models.afterLink": ", w tym modele lokalne",
  "temp.screenshot.caption": "CruxCLI TUI z motywem tokyonight",
  "temp.screenshot.alt": "CruxCLI TUI z motywem tokyonight",
  "temp.logoLightAlt": "jasne logo cruxcli",
  "temp.logoDarkAlt": "ciemne logo cruxcli",
  ...
  "home.what.title": "Czym jest CruxCLI?",
  "home.what.body":
    "CruxCLI to open source'owy agent, który pomaga pisać kod w terminalu, IDE lub aplikacji desktopowej.",
  ...
  "home.growth.body":
    "Z ponad <strong>{{stars}}</strong> gwiazdkami na GitHubie, <strong>{{contributors}}</strong> współtwórcami i ponad <strong>{{commits}}</strong> commitami, CruxCLI jest używany i ceniony przez ponad <strong>{{monthlyUsers}}</strong> deweloperów każdego miesiąca.",
  ...
  "home.privacy.body":
    "CruxCLI nie przechowuje Twojego kodu ani danych kontekstowych, dzięki czemu może działać w środowiskach wrażliwych na prywatność.",
  "home.privacy.learnMore": "Dowiedz się więcej o",
  "home.privacy.link": "prywatności",

  "home.faq.q1": "Czym jest CruxCLI?",
  "home.faq.a1":
    "CruxCLI to open source'owy agent, który pomaga pisać i uruchamiać kod z dowolnym modelem AI. Jest dostępny jako interfejs terminalowy, aplikacja desktopowa lub rozszerzenie IDE.",
  "home.faq.q2": "Jak korzystać z CruxCLI?",
  "home.faq.a2.before": "Najłatwiej zacząć od przeczytania",
  "home.faq.a2.link": "wprowadzenia",
  "home.faq.q3": "Czy potrzebuję dodatkowych subskrypcji AI, aby używać CruxCLI?",
  "home.faq.a3.p1":
    "Niekoniecznie. CruxCLI posiada zestaw darmowych modeli, z których możesz korzystać bez zakładania konta.",
  "home.faq.a3.p2.beforeZen": "Poza tym możesz używać dowolnych popularnych modeli do kodowania, tworząc konto",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Chociaż zachęcamy do korzystania z Zen, CruxCLI działa również ze wszystkimi popularnymi dostawcami, takimi jak OpenAI, Anthropic, xAI itp.",
  "home.faq.a3.p4.beforeLocal": "Możesz nawet podłączyć swoje",
  "home.faq.a3.p4.localLink": "lokalne modele",
  "home.faq.q4": "Czy mogę używać moich istniejących subskrypcji AI z CruxCLI?",
  "home.faq.a4.p1":
    "Tak, CruxCLI obsługuje plany subskrypcyjne od wszystkich głównych dostawców. Możesz używać swoich subskrypcji Claude Pro/Max, ChatGPT Plus/Pro lub GitHub Copilot.",
  "home.faq.q5": "Czy mogę używać CruxCLI tylko w terminalu?",
  "home.faq.a5.beforeDesktop": "Już nie! CruxCLI jest teraz dostępny jako aplikacja na",
  "home.faq.a5.desktop": "pulpit (desktop)",
  "home.faq.a5.and": "i",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Ile kosztuje CruxCLI?",
  "home.faq.a6":
    "CruxCLI jest w 100% darmowy. Zawiera również zestaw darmowych modeli. Mogą pojawić się dodatkowe koszty, jeśli podłączysz innego dostawcę.",
  ...
  "home.faq.q8": "Czy CruxCLI jest open source?",
  "home.faq.a8.p1": "Tak, CruxCLI jest w pełni open source. Kod źródłowy jest publicznie dostępny na",
  ...
  "home.zenCta.body":
    "Zen daje dostęp do wyselekcjonowanego zestawu modeli AI, które CruxCLI przetestował i sprawdził (benchmark) specjalnie dla agentów kodujących. Nie musisz martwić się o niespójną wydajność i jakość u różnych dostawców, używaj sprawdzonych modeli, które działają.",
  "home.zenCta.link": "Dowiedz się więcej o Zen",

  "zen.title": "CruxCLI Zen | Wyselekcjonowany zestaw niezawodnych, zoptymalizowanych modeli dla agentów kodujących",
  "zen.hero.title": "Niezawodne, zoptymalizowane modele dla agentów kodujących",
  "zen.hero.body":
    "Zen daje dostęp do wyselekcjonowanego zestawu modeli AI, które CruxCLI przetestował i sprawdził (benchmark) specjalnie dla agentów kodujących. Nie musisz martwić się o niespójną wydajność i jakość, używaj sprawdzonych modeli, które działają.",

  "zen.faq.q1": "Czym jest CruxCLI Zen?",
  "zen.faq.a1":
    "Zen to wyselekcjonowany zestaw modeli AI przetestowanych i sprawdzonych pod kątem agentów kodujących, stworzony przez zespół stojący za CruxCLI.",
  ...
  "zen.faq.a3":
    "Zen nie jest nastawiony na zysk. Zen przekazuje koszty od dostawców modeli bezpośrednio do Ciebie. Im większe użycie Zen, tym lepsze stawki CruxCLI może wynegocjować i przekazać Tobie.",
  ...
  "zen.faq.a4.p3":
    "Aby pokryć koszty, CruxCLI dolicza jedynie niewielką opłatę za przetwarzanie płatności w wysokości $1.23 przy każdym doładowaniu salda o $20.",
  ...
  "zen.faq.a8":
    "Chociaż Zen świetnie działa z CruxCLI, możesz używać Zen z dowolnym agentem. Postępuj zgodnie z instrukcjami konfiguracji w swoim preferowanym agencie.",
  ...
  "zen.problem.subtitle": "Naprawiamy to dla wszystkich, nie tylko dla użytkowników CruxCLI.",
  ...
  "zen.how.body": "Chociaż sugerujemy używanie Zen z CruxCLI, możesz używać Zen z dowolnym agentem.",
  ...
  "go.title": "CruxCLI Go | Niskokosztowe modele do kodowania dla każdego",
  "go.meta.description":
  ...
  "go.testimonials.handle": "@CruxCLI",
  ...
  "go.problem.body":
    "Skupiamy się na dostarczeniu doświadczenia CruxCLI jak największej liczbie osób. CruxCLI Go to niskokosztowa ($10/miesiąc) subskrypcja zaprojektowana, aby udostępnić programowanie z agentami programistom na całym świecie. Zapewnia hojne limity i niezawodny dostęp do najzdolniejszych modeli open source.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go to subskrypcja za $10/miesiąc, której możesz używać z CruxCLI lub dowolnym agentem.",
  ...
  "go.faq.q1": "Czym jest CruxCLI Go?",
  "go.faq.a1":
  ...
  "black.meta.title": "CruxCLI Black | Dostęp do najlepszych na świecie modeli kodujących",
  "black.meta.description": "Uzyskaj dostęp do Claude, GPT, Gemini i innych dzięki planom subskrypcji CruxCLI Black.",
  "black.hero.title": "Dostęp do najlepszych na świecie modeli kodujących",
  "black.hero.subtitle": "W tym Claude, GPT, Gemini i inne",
  "black.title": "CruxCLI Black | Cennik",
  ...
  "black.workspace.title": "CruxCLI Black | Wybierz obszar roboczy",
  "black.workspace.selectPlan": "Wybierz obszar roboczy dla tego planu",
  "black.workspace.name": "Obszar roboczy {{n}}",
  "black.subscribe.title": "Subskrybuj CruxCLI Black",
  ...
  "black.subscribe.success.title": "Jesteś na liście oczekujących CruxCLI Black",
  "black.subscribe.success.subscriptionPlan": "Plan subskrypcji",
  "black.subscribe.success.planName": "CruxCLI Black {{plan}}",
  ...
  "workspace.newUser.feature.lockin.body":
    "Używaj Zen z dowolnym agentem kodującym i kontynuuj korzystanie z innych dostawców z CruxCLI, kiedy tylko chcesz.",
  ...
  "workspace.newUser.step.login.after": "i wybierz cruxcli",
  "workspace.newUser.step.pasteKey": "Wklej swój klucz API",
  "workspace.newUser.step.models.before": "Uruchom cruxcli i wpisz",
  ...
  "workspace.keys.subtitle": "Zarządzaj kluczami API do usług cruxcli.",
  "workspace.keys.create": "Utwórz klucz API",
  "workspace.keys.placeholder": "Wpisz nazwę klucza",
  "workspace.keys.empty": "Utwórz klucz API bramy cruxcli",
  ...
  "workspace.black.subscription.message": "Subskrybujesz CruxCLI Black za ${{plan}} miesięcznie.",
  ...
  "workspace.black.waitlist.joined": "Jesteś na liście oczekujących na plan CruxCLI Black za ${{plan}} miesięcznie.",
  "workspace.black.waitlist.ready": "Jesteśmy gotowi zapisać Cię do planu CruxCLI Black za ${{plan}} miesięcznie.",
  ...
  "workspace.lite.subscription.message": "Subskrybujesz CruxCLI Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Wybierz "CruxCLI Go" jako dostawcę w konfiguracji cruxcli, aby używać modeli Go.',
  "workspace.lite.other.title": "Subskrypcja Go",
  "workspace.lite.other.message":
    "Inny członek tego obszaru roboczego już subskrybuje CruxCLI Go. Tylko jeden członek na obszar roboczy może subskrybować.",
  "workspace.lite.promo.title": "CruxCLI Go",
  "workspace.lite.promo.description":
    "CruxCLI Go to subskrypcja za $10 miesięcznie, która zapewnia niezawodny dostęp do popularnych otwartych modeli do kodowania z hojnymi limitami użycia.",
  ...
  "download.title": "CruxCLI | Pobierz",
  "download.meta.description": "Pobierz CruxCLI na macOS, Windows i Linux",
  "download.hero.title": "Pobierz CruxCLI",
  "download.hero.subtitle": "Dostępne w wersji Beta na macOS, Windows i Linux",
  "download.hero.button": "Pobierz na {{os}}",
  "download.section.terminal": "Terminal CruxCLI",
  "download.section.desktop": "Pulpit CruxCLI (Beta)",
  "download.section.extensions": "Rozszerzenia CruxCLI",
  "download.section.integrations": "Integracje CruxCLI",
  ...
  "download.faq.a3.beforeLocal":
    "Niekoniecznie, ale prawdopodobnie. Będziesz potrzebować subskrypcji AI, jeśli chcesz połączyć CruxCLI z płatnym dostawcą, chociaż możesz pracować z",
  ...
  "download.faq.a3.afterZen":
    ", CruxCLI współpracuje ze wszystkimi popularnymi dostawcami, takimi jak OpenAI, Anthropic, xAI itp.",

  "download.faq.a5.p1": "CruxCLI jest w 100% darmowy.",
  "download.faq.a5.p2.beforeZen":
    "Wszelkie dodatkowe koszty będą pochodzić z Twojej subskrypcji u dostawcy modelu. Chociaż CruxCLI współpracuje z dowolnym dostawcą modeli, zalecamy korzystanie z",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Twoje dane i informacje są przechowywane tylko wtedy, gdy tworzysz linki do udostępniania w CruxCLI.",
  "download.faq.a6.p2.beforeShare": "Dowiedz się więcej o",
  "download.faq.a6.shareLink": "stronach udostępniania",

  "enterprise.title": "CruxCLI | Rozwiązania Enterprise dla Twojej organizacji",
  "enterprise.meta.description": "Skontaktuj się z CruxCLI w sprawie rozwiązań dla przedsiębiorstw",
  "enterprise.hero.title": "Twój kod jest Twój",
  "enterprise.hero.body1":
    "CruxCLI działa bezpiecznie wewnątrz Twojej organizacji bez przechowywania danych czy kontekstu, oraz bez ograniczeń licencyjnych czy roszczeń własnościowych. Rozpocznij okres próbny ze swoim zespołem, a następnie wdróż go w całej organizacji, integrując z SSO i wewnętrzną bramą AI.",
  ...
  "enterprise.faq.q1": "Czym jest CruxCLI Enterprise?",
  "enterprise.faq.a1":
    "CruxCLI Enterprise jest dla organizacji, które chcą mieć pewność, że ich kod i dane nigdy nie opuszczą ich infrastruktury. Można to osiągnąć dzięki scentralizowanej konfiguracji, która integruje się z Twoim SSO i wewnętrzną bramą AI.",
  "enterprise.faq.q2": "Jak zacząć z CruxCLI Enterprise?",
  "enterprise.faq.a2":
    "Po prostu rozpocznij wewnętrzny okres próbny ze swoim zespołem. CruxCLI domyślnie nie przechowuje Twojego kodu ani danych kontekstowych, co ułatwia start. Następnie skontaktuj się z nami, aby omówić opcje cenowe i wdrożeniowe.",
  ...
  "enterprise.faq.q4": "Czy moje dane są bezpieczne z CruxCLI Enterprise?",
  "enterprise.faq.a4":
    "Tak. CruxCLI nie przechowuje Twojego kodu ani danych kontekstowych. Całe przetwarzanie odbywa się lokalnie lub poprzez bezpośrednie wywołania API do Twojego dostawcy AI. Dzięki centralnej konfiguracji i integracji SSO, Twoje dane pozostają bezpieczne w infrastrukturze Twojej organizacji.",

  "brand.title": "CruxCLI | Marka",
  "brand.meta.description": "Wytyczne marki CruxCLI",
  "brand.heading": "Wytyczne marki",
  "brand.subtitle": "Zasoby i aktywa, które pomogą Ci pracować z marką CruxCLI.",
  "brand.downloadAll": "Pobierz wszystkie zasoby",

  "changelog.title": "CruxCLI | Dziennik zmian",
  "changelog.meta.description": "Notatki o wydaniu i dziennik zmian CruxCLI",
  "changelog.hero.title": "Dziennik zmian",
  "changelog.hero.subtitle": "Nowe aktualizacje i ulepszenia CruxCLI",
