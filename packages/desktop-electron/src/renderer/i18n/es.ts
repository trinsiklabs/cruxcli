export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de CruxCLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de CruxCLI. ¿Quieres instalarla y reiniciar?",
