...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    },
    {
      label: "Help",
      submenu: [
        { label: "CruxCLI Documentation", click: () => shell.openExternal("https://cruxcli.dev/docs") },
        { label: "Support Forum", click: () => shell.openExternal("https://discord.com/invite/cruxcli") },
        { type: "separator" },
        { type: "separator" },
        {
          label: "Share Feedback",
          click: () =>
            shell.openExternal("https://github.com/trinsiklabs/cruxcli/issues/new?template=feature_request.yml"),
        },
        {
          label: "Report a Bug",
          click: () => shell.openExternal("https://github.com/trinsiklabs/cruxcli/issues/new?template=bug_report.yml"),
        },
      ],
    },
  ]
