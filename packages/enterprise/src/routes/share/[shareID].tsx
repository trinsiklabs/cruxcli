import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@cruxcli/sdk/v2"
import { SessionTurn } from "@cruxcli/ui/session-turn"
import { SessionReview } from "@cruxcli/ui/session-review"
import { DataProvider } from "@cruxcli/ui/context"
import { FileComponentProvider } from "@cruxcli/ui/context/file"
import { WorkerPoolProvider } from "@cruxcli/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@cruxcli/ui/logo"
import { IconButton } from "@cruxcli/ui/icon-button"
import { ProviderIcon } from "@cruxcli/ui/provider-icon"
import { createDefaultOptions } from "@cruxcli/ui/pierre"
import { iife } from "@cruxcli/util/iife"
import { Binary } from "@cruxcli/util/binary"
import { NamedError } from "@cruxcli/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@cruxcli/ui/tabs"
import { MessageNav } from "@cruxcli/ui/message-nav"
import { preloadMultiFileDiff, PreloadMultiFileDiffResult } from "@pierre/diffs/ssr"
import { FileSSR } from "@cruxcli/ui/file-ssr"
import { clientOnly } from "@solidjs/start"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@cruxcli/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/cruxcli-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | CruxCLI</Title>
              </Show>
              <Meta name="description" content="cruxcli - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/trinsiklabs/cruxcli"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://cruxcli.dev/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
