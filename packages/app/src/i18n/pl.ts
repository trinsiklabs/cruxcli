export const dict = {
  ...
  "dialog.provider.cruxcli.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.cruxcli.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.cruxcliGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez CruxCLI",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w CruxCLI.",
  ...
  "provider.connect.cruxcliZen.line1":
    "CruxCLI Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.cruxcliZen.visit.prefix": "Odwiedź ",
  "provider.connect.cruxcliZen.visit.link": "cruxcli.dev/zen",
  "provider.connect.cruxcliZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w CruxCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w CruxCLI.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w cruxcli.json",
  ...
  "dialog.server.description": "Przełącz serwer CruxCLI, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja CruxCLI ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu CruxCLI",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (cruxcli.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, CruxCLI does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "CruxCLI zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the CruxCLI server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla CruxCLI",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd CruxCLI na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw CruxCLI.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania CruxCLI",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji CruxCLI.",
