export const dict = {
  ...
  "dialog.provider.cruxcli.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.cruxcli.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.cruxcliGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af CruxCLI",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i CruxCLI.",
  ...
  "provider.connect.cruxcliZen.line1":
    "CruxCLI Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.cruxcliZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.cruxcliZen.visit.prefix": "Besøg ",
  "provider.connect.cruxcliZen.visit.link": "cruxcli.dev/zen",
  "provider.connect.cruxcliZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i CruxCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i CruxCLI.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i cruxcli.json",
  ...
  "dialog.server.description": "Skift hvilken CruxCLI-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af CruxCLI ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til CruxCLI-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (cruxcli.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, CruxCLI understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "CruxCLI inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør CruxCLI-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for CruxCLI",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan CruxCLI ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan CruxCLI er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når CruxCLI starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af CruxCLI.",
