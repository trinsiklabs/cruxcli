export const dict = {
  ...
  "dialog.provider.cruxcli.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.cruxcli.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.cruxcliGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo CruxCLI",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no CruxCLI.",
  ...
  "provider.connect.cruxcliZen.line1":
    "CruxCLI Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.cruxcliZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.cruxcliZen.visit.prefix": "Visite ",
  "provider.connect.cruxcliZen.visit.link": "cruxcli.dev/zen",
  "provider.connect.cruxcliZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no CruxCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no CruxCLI.",
  ...
  "dialog.plugins.empty": "Plugins configurados em cruxcli.json",
  ...
  "dialog.server.description": "Trocar para qual servidor CruxCLI este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do CruxCLI ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do CruxCLI",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (cruxcli.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: CruxCLI ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "CruxCLI inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor CruxCLI dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do CruxCLI",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o CruxCLI aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o CruxCLI é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o CruxCLI iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do CruxCLI.",
