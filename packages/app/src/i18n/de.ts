...
export const dict = {
  ...
  "dialog.provider.cruxcli.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.cruxcli.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.cruxcliGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von CruxCLI",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in CruxCLI zu nutzen.",
  ...
  "provider.connect.cruxcliZen.line1":
    "CruxCLI Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.cruxcliZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.cruxcliZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.cruxcliZen.visit.link": "cruxcli.dev/zen",
  "provider.connect.cruxcliZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in CruxCLI zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in CruxCLI zu nutzen.",
  ...
  "dialog.plugins.empty": "In cruxcli.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den CruxCLI-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von CruxCLI ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem CruxCLI-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (cruxcli.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: CruxCLI unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "CruxCLI enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "CruxCLI Desktop",
  ...
  "settings.desktop.wsl.description": "CruxCLI-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für CruxCLI ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie CruxCLI auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von CruxCLI anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von CruxCLI automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von CruxCLI.",
