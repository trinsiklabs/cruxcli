...
export const dict = {
  ...
  "dialog.provider.cruxcli.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.cruxcli.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.cruxcliGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "CruxCLI tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve CruxCLI'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.cruxcliZen.line1":
    "CruxCLI Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.cruxcliZen.visit.prefix": "",
  "provider.connect.cruxcliZen.visit.link": "cruxcli.dev/zen",
  "provider.connect.cruxcliZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve CruxCLI'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak CruxCLI'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler cruxcli.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi CruxCLI sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "CruxCLI'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı CruxCLI ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (cruxcli.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: CruxCLI henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "CruxCLI ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "CruxCLI Masaüstü",
  ...
  "settings.desktop.wsl.description": "CruxCLI sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "CruxCLI'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "CruxCLI'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "CruxCLI'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "CruxCLI başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "CruxCLI'un en son sürümünü kullanıyorsunuz.",
