export const dict = {
  ...
  "dialog.provider.cruxcli.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.cruxcli.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.cruxcliGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje CruxCLI",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u CruxCLI-u.",
  ...
  "provider.connect.cruxcliZen.line1":
    "CruxCLI Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.cruxcliZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.cruxcliZen.visit.prefix": "Posjeti ",
  "provider.connect.cruxcliZen.visit.link": "cruxcli.dev/zen",
  "provider.connect.cruxcliZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u CruxCLI-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u CruxCLI-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u cruxcli.json",
  ...
  "dialog.server.description": "Promijeni na koji se CruxCLI server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija CruxCLI-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku CruxCLI timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (cruxcli.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: CruxCLI još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "CruxCLI uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni CruxCLI server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u CruxCLI-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako CruxCLI izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu CruxCLI-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se CruxCLI pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju CruxCLI-a.",
