...
export const dict = {
  ...
  "dialog.provider.cruxcli.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.cruxcli.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.cruxcliGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av CruxCLI",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i CruxCLI.",
  ...
  "provider.connect.cruxcliZen.line1":
    "CruxCLI Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.cruxcliZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.cruxcliZen.visit.prefix": "Besøk ",
  "provider.connect.cruxcliZen.visit.link": "cruxcli.dev/zen",
  "provider.connect.cruxcliZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i CruxCLI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i CruxCLI.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i cruxcli.json",
  ...
  "dialog.server.description": "Bytt hvilken CruxCLI-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av CruxCLI ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til CruxCLI-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (cruxcli.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at CruxCLI ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "CruxCLI inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør CruxCLI-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for CruxCLI",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan CruxCLI ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan CruxCLI er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når CruxCLI starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av CruxCLI.",
