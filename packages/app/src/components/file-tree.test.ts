...
beforeAll(async () => {
  ...
  mock.module("@cruxcli/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@cruxcli/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@cruxcli/ui/icon", () => ({ Icon: () => null }))
  mock.module("@cruxcli/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
