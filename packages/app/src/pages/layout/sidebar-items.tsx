import type { Message, Session, TextPart, UserMessage } from "@cruxcli/sdk/v2/client"
import { Avatar } from "@cruxcli/ui/avatar"
import { HoverCard } from "@cruxcli/ui/hover-card"
...
const CRUXCLI_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === CRUXCLI_PROJECT_ID ? "https://cruxcli.dev/favicon.svg" : props.project.icon?.override
          }
