...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CRUXCLI_CALLER", () => {
    process.env["CRUXCLI_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CRUXCLI_CALLER", () => {
    process.env["CRUXCLI_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CRUXCLI_CALLER", () => {
    process.env["CRUXCLI_CALLER"] = "unknown"
