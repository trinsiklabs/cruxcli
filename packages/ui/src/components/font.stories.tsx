...
const docs = `### Overview
Loads CruxCLI typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>CruxCLI Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>CruxCLI Mono Sample</div>
    </div>
  ),
}
