...
/**
 * Server configuration for cruxcli serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: cruxcli.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://cruxcli.dev/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://cruxcli.dev/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
