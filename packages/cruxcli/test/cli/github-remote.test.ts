...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/cruxcli.git")).toEqual({ owner: "sst", repo: "cruxcli" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/cruxcli")).toEqual({ owner: "sst", repo: "cruxcli" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/cruxcli.git")).toEqual({ owner: "sst", repo: "cruxcli" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/cruxcli")).toEqual({ owner: "sst", repo: "cruxcli" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/cruxcli.git")).toEqual({ owner: "sst", repo: "cruxcli" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/cruxcli")).toEqual({ owner: "sst", repo: "cruxcli" })
})
