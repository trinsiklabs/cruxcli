...
1. `$CRUXCLI_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.cruxcli/bin` - Alternativa por defecto
...
CruxCLI incluye dos agents integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agents](https://cruxcli.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar CruxCLI, [**ve a nuestra documentación**](https://cruxcli.ai/docs).

### Contribuir

Si te interesa contribuir a CruxCLI, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Construyendo sobre CruxCLI

Si estás trabajando en un proyecto relacionado con CruxCLI y usas "cruxcli" como parte del nombre; por ejemplo, "cruxcli-dashboard" u "cruxcli-mobile", agrega una nota en tu README para aclarar que no está construido por el equipo de CruxCLI y que no está afiliado con nosotros de ninguna manera.
...
- 100% open source
- No está acoplado a ningún proveedor. Aunque recomendamos los modelos que ofrecemos a través de [CruxCLI Zen](https://cruxcli.ai/zen); CruxCLI se puede usar con Claude, OpenAI, Google o incluso modelos locales. A medida que evolucionan los modelos, las brechas se cerrarán y los precios bajarán, por lo que ser agnóstico al proveedor es importante.
- Soporte LSP listo para usar
- Un enfoque en la TUI. CruxCLI está construido por usuarios de neovim y los creadores de [terminal.shop](https://terminal.shop); vamos a empujar los límites de lo que es posible en la terminal.
- Arquitectura cliente/servidor. Esto, por ejemplo, permite ejecutar CruxCLI en tu computadora mientras lo controlas de forma remota desde una app móvil. Esto significa que el frontend TUI es solo uno de los posibles clientes.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/cruxcli) | [X.com](https://x.com/cruxcli)
