   ...
   jobs:
     opencode:
       ...
       steps:
          ...
          - name: Run opencode
           uses: trinsiklabs/opencode/github@latest
           env:
...
This is an early release. If you encounter issues or have feedback, please create an issue at https://github.com/trinsiklabs/opencode/issues.
