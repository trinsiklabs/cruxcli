...
brew install anomalyco/tap/cruxcli # macOS і Linux (рекомендовано, завжди актуально)
...
nix run nixpkgs#cruxcli           # або github:anomalyco/cruxcli для найновішої dev-гілки
```
...
CruxCLI також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/anomalyco/cruxcli/releases) або [cruxcli.ai/download](https://cruxcli.ai/download).
