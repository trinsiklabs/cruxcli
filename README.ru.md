...
brew install trinsiklabs/tap/cruxcli # macOS и Linux (рекомендуем, всегда актуально)
...
nix run nixpkgs#cruxcli           # или github:trinsiklabs/cruxcli для самой свежей ветки dev
```
...
CruxCLI также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/trinsiklabs/cruxcli/releases) или с [cruxcli.ai/download](https://cruxcli.ai/download).
