...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/trinsiklabs/cruxcli/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for trinsiklabs/cruxcli...\n")
...
console.log("Fetching npm all-time downloads for cruxcli...\n")
const npmDownloads = await fetchNpmDownloads("cruxcli")
