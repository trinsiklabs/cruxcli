...
- **GitHub:** https://github.com/sst/opencode (129,357 stars)
- **Category:** Direct (upstream fork source)
- **License:** MIT
- **Latest:** v1.3.0 (2026-03-22)
...
**Their moat vs us:**
- Community size (129k stars vs our 0) — must-close via adoption/marketing
...
- **GitHub:** https://github.com/anthropics/claude-code (82,049 stars)
- **Category:** Direct
- **License:** Proprietary
- **Latest:** Continuous releases
...
- **GitHub:** https://github.com/google-gemini/gemini-cli (98,907 stars)
- **Category:** Direct
- **License:** Apache-2.0
- **Latest:** Active development (2026-03)
- **One-line:** Google's terminal agent with Gemini 3, 1M context, Google Search grounding.

**Strengths:**
- 98k stars — massive adoption in 2 months
...
- **GitHub:** https://github.com/openai/codex (67,280 stars)
- **Category:** Direct
- **License:** Apache-2.0
- **Latest:** Active development (2026-03)
...
|------|-----|-------|-------------|
| Aider | github.com/paul-gauthier/aider | 42,325 | Pioneer terminal agent, repo map concept. No release in 7+ months — may be stalling or preparing major version. |
| Cline | github.com/cline/cline | 59,302 | IDE-bound (VS Code) but influences user expectations. Plan/Act modes, MCP integration. |
| Roo Code | github.com/RooVetGit/Roo-Code | 22,818 | Custom modes system closest to Crux's. Mode Gallery for community sharing. |
| Goose | github.com/block/goose | 33,517 | Block (Square) backed. Extensible, any LLM, runs locally. |
