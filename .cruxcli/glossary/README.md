...
Use this folder for locale-specific translation guidance that supplements `.cruxcli/agent/translator.md`.
...
- PR #12345: https://github.com/trinsiklabs/cruxcli/pull/12345

## Do Not Translate (Locale Additions)

- `CruxCLI` (preserve casing)
