...
- PR #15835: https://github.com/trinsiklabs/cruxcli/pull/15835

## Do Not Translate (Locale Additions)

- `CruxCLI` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `cruxcli` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `CruxCLI` in prose, `cruxcli` only for exact technical identifiers
...
- Avoid changing `cruxcli` to `CruxCLI` inside commands, URLs, package names, or code literals
