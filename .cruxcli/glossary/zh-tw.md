...
- PR #13942: https://github.com/trinsiklabs/cruxcli/pull/13942

## Do Not Translate (Locale Additions)

- `CruxCLI` (preserve casing in prose; keep `cruxcli` only when it is part of commands, package names, paths, or code)
- `CruxCLI Zen`
- `CruxCLI CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `cruxcli` in prose when referring to the product name; use `CruxCLI`
